...
public class Corporation
{
    ...
    [MaxLength(100, ErrorMessage = "Il massimo dei caratteri consentito es {0}")]
    [Required(ErrorMessage = "El campo {0} es Requerido")]
    [Display(Name = "Impresa/Persona")]
    public string? Name { get; set; }

    [MaxLength(15, ErrorMessage = "Il massimo dei caratteri consentito es {0}")]
    [Required(ErrorMessage = "El {0} es Obligatorio")]
    [Display(Name = "RUC ó DNI")]
    public string? NroDocument { get; set; }

    [MaxLength(12, ErrorMessage = "Il massimo dei caratteri consentito es {1}")]
    [Required(ErrorMessage = "El {0} es Obligatorio")]
    ...
    public ICollection<UserRoleDetails>? UserRoles { get; set; }
}
